...
function EditorReviewScreen() {
  ...
  return (
    <div style={{ position:'relative', width:'100%', height:'100%', background:'#F1F6F6', overflow:'hidden' }}>
      <IOSStatusBar dark={false} />

      {/* Back button — absolute so it floats above the scroller */}
      <button
        ...
        style={{
          ...
          top:`calc(${safeTop} + 28px)`,
          width:40, height:40, borderRadius:20,
          background:'rgba(255,255,255,0.01)', border:'none',
          display:'flex', alignItems:'center', justifyContent:'center',
          cursor:'pointer', transition:'transform 140ms ease', zIndex:10,
          WebkitTapHighlightColor:'transparent',
        }}
      >
        <svg width="12" height="20" viewBox="0 0 12 20" fill="none">
          <path d="M10 2L2 10l8 8" stroke="#333" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </button>

      {/* Scrollable content */}
      <div style={{ position:'absolute', inset:0, overflowY:'auto', scrollbarWidth:'none', paddingBottom:120 }}>

        {/* Top section — title + product card */}
        <div style={{ paddingTop:`calc(${safeTop} + 88px)`, paddingLeft:24, paddingRight:24 }}>
          <p style={{
            fontFamily:ER_DISPLAY, fontSize:34, fontWeight:700,
            color:'#333', letterSpacing:'0.37px', lineHeight:'41px',
            margin:'0 0 16px',
          }}>Your photo book</p>
          ...
          <div style={{
            ...
            {ADD_ON_CARDS.map((card, i) => (
              ...
              >
                ...
                {/* Info icon bottom-right (above caption) */}
                <img
                ...
                {/* Caption area with backdrop blur */}
                <div style={{
      ...
      <div style={{
        ...
        >
          <img src={`${ER_A}/pb-review-basket.svg`} alt="" width={24} height={24} style={{filter:'brightness(0) invert(1)'}} />
          Add to Basket
        </button>
      </div>
    </div>
