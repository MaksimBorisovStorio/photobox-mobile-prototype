...
function OnboardingScreen() {
  const SLIDE = 2;
  const onNext = () => window.navigation.push('onboarding-3.html');
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img
          src="https://picsum.photos/seed/onboard2/390/480"
          alt=""
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          <h1 style={{
            ...
            Your memories, perfectly printed
          </h1>
          <p style={{
            fontFamily: 'var(--font)',
            ...
            From photo books to wall art, create stunning keepsakes that last a lifetime.
          </p>
        </div>
